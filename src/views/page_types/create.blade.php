	...
	{{ Form::open() }}
		<div class="well">
			<div class="control_block">
				...
				{{ Form::input('text', 'name', Input::has('name') ? Input::get('name') : $page_type->name(), array('class' => 'input--text')) }}
			</div>
			<div class="control_block">
				{{ Form::label('table_prefix', 'Table Prefex', array('class' => 'label--block')) }}
				{{ Form::input('text', 'table_prefix', Input::has('table_prefix') ? Input::get('table_prefix') : $page_type->tablePrefix(), array('class' => 'input--text')) }}
			</div>
			<div class="control_block">
